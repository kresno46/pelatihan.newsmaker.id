...
class ApupptAbsensiExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($absensi): array
    {
        return [
            ...
            $absensi->user->cabang ?? '-',
            $absensi->waktu_absen ? \Carbon\Carbon::parse($absensi->waktu_absen)->format('d F Y, H:i') : '-',
        ];
    }
