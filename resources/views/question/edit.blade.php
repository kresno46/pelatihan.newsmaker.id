...
<div class="card p-6 bg-white dark:bg-gray-800 rounded shadow">
    <form id="pivotForm" action="{{ route('question.update', [$quiz->slug, $question->id]) }}" method="POST"
        ...
        <div class="flex justify-between items-center mb-5">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Edit Pertanyaan untuk {{ $quiz->title }}
            </h2>
        ...
        <div class="space-y-5">
            ...
            <div class="w-full">
                ...
                <textarea name="question" id="question" rows="5"
                    class="w-full border rounded p-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('question') border-red-500 dark:border-red-400 @enderror">{{ old('question', $question->question) }}</textarea>
                @error('question')
...
<div id="submitModal" class="fixed inset-0 bg-black/50 backdrop-blur flex items-center justify-center hidden px-5">
    <div class="bg-white dark:bg-gray-800 rounded p-6 w-full max-w-md text-gray-900 dark:text-gray-100">
        ...
        <p class="mb-6">Apakah Anda yakin ingin menyimpan perubahan?</p>
