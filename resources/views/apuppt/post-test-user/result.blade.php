                ...
                @if ($result->score < 60)
                    <div class="mt-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl">
                        <p class="text-red-600 dark:text-red-400 font-semibold">Nilai Anda kurang dari 60. Silakan Remedial
                            APUPPT pada gelombang berikutnya.</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div
            ...
            <div class="p-6 lg:p-8">
                ...
                <div class="text-center space-y-3">
                    @if ($result->score >= 60)
                        <div>
                            <a href="{{ route('apuppt.sertifikatUser.download', $result->id) }}"
                                class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3 rounded-xl transition-all shadow-lg hover:shadow-xl">
                                <i class="fa-solid fa-certificate"></i>
                                Download Sertifikat APUPPT
                            </a>
                        </div>
                    @endif
