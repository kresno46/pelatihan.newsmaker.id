        ...
        <div
            ...
            <div class="flex">
                <a href="{{ route('apuppt.test.index') }}"
                    class="flex-1 text-sm py-2 px-6 text-center font-semibold bg-blue-600 text-white shadow-lg">
                    APUPPT
                </a>
            </div>
        </div>
                                ...
                                @foreach ($tests->where('status', true) as $index => $posttest)
                                    <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            @if ($posttest->progres === 'Belum Dikerjakan')
                                                <a href="{{ route('apuppt.test.show', $posttest->slug) }}"
                                            ...
                                            @else
                                                <a href="{{ route('apuppt.test.result', $posttest->result_id) }}"
