        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-3" id="filterForm">
            ...
            <div>
                ...
                <select name="kategori"
                    ...
                    <option value="APUPPT" {{ $kategori === 'APUPPT' ? 'selected' : '' }}>APUPPT</option>
            ...
            <div class="flex items-end gap-2 md:col-span-6">
                ...
                <div class="relative">
                    ...
                    <div id="downloadMenu"
                        ...
                        <div class="py-1">
                            <a href="{{ route('apuppt.sertifikat.export', request()->query()) }}"
                                class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <i class="fas fa-file-excel mr-2 text-green-600"></i>
                                Download Excel
                            </a>
                            @if (request('cabang'))
                                <a href="{{ route('apuppt.sertifikat.exportPerCabang', request()->query()) }}"
                                    class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/30">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">
                                        ...
                                        <button class="text-red-600 dark:text-red-400 hover:underline"
                                            onclick="showDeleteModal('{{ route('apuppt.sertifikat.destroy', $item->id) }}')">
                                            Hapus
                                        </button>
                                    </td>
                                </tr>
