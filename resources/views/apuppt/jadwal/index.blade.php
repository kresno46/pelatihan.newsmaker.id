    ...
    <div>
        <div class="p-5 bg-white dark:bg-gray-800 rounded-lg shadow-lg space-y-5">
            ...
            <div class="flex items-center justify-between w-full">
                ...
                <a href="{{ route('apuppt.absensi.create') }}"
            ...
            <div class="flex items-center space-x-4">
                <div class="flex-1">
                    <form method="GET" action="{{ route('apuppt.absensi.index') }}" class="flex items-center">
                ...
                @foreach ($jadwals as $jadwal)
                    <div
                        ...
                        <div class="flex flex-col justify-between mb-2 h-full">
                            <div>
                                ...
                                <div class="text-gray-600 dark:text-gray-300 text-xs mt-1">
                                    ...
                                    ({{ $jadwal->postTestSession->questions_count ?? 0 }} pertanyaan)
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col items-end gap-3">
                            <form action="{{ route('apuppt.absensi.toggle', $jadwal->id) }}" method="POST" class="h-fit">
                                @csrf
                            ...
                            <div class="flex items-center gap-4">
                                <a href="{{ route('apuppt.absensiAdmin.index', $jadwal->id) }}" class="text-blue-500"
                                    title="Lihat List Absen">
                                    <i class="fa-solid fa-eye"></i>
                                </a>

                                <a href="{{ route('apuppt.absensi.edit', $jadwal->id) }}" class="text-yellow-500">
                    ...
                    <div id="modalDelete-{{ $jadwal->id }}"
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md">
                            ...
                            <div class="flex justify-end gap-3 px-6 py-4">
                                ...
                                <form action="{{ route('apuppt.absensi.destroy', $jadwal->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
