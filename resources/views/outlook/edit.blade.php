...
@section('content')
    <div class="card p-6 bg-white dark:bg-gray-800 rounded shadow">
        <form id="pivotForm" action="{{ route('outlook.update', [$folder->slug, $outlook->slug]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-between items-center mb-5">
                ...
                <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Edit Outlook</h2>
            ...
            <div class="space-y-5">
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $outlook->title) }}"
                ...
                <div class="flex gap-4">
                    ...
                    <div class="w-full">
                        ...
                        @enderror
                        <div class="mt-2">
                            <img src="{{ asset($outlook->cover) }}" alt="Cover Outlook" class="w-32 h-auto rounded shadow">
                        </div>
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        @enderror
                        <div class="mt-2">
                            <a href="{{ asset($outlook->file) }}" target="_blank" class="text-blue-600 hover:underline">Lihat File Saat Ini</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="10"
                        class="w-full border rounded p-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-gray-400 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('deskripsi') border-red-500 dark:border-red-400 @enderror">{{ old('deskripsi', $outlook->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="text-red-600 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
