...
@section('namePage', 'Tambah Materi')

@section('content')
    <div class="card p-6 bg-white dark:bg-gray-800 rounded shadow">
        <form id="pivotForm" action="{{ route('folder.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div class="w-full">
                    ...
                    <input type="text" name="folder_name" id="folder_name" value="{{ old('folder_name') }}"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md">
            ...
            <div class="px-6 py-4 border-t border-b border-gray-200 dark:border-gray-700">
                <p class="text-gray-700 dark:text-gray-300">
                    Apakah Anda yakin ingin menyimpan buku ini?
                </p>
            </div>
