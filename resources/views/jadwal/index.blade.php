        ...
        <div id="addModal"
            ...
            <div id="addModalContent"
                ...
                <form action="{{ route('absensi.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm text-gray-700 dark:text-gray-300">Judul Sesi</label>
...
@section('scripts')
    <script>
        ...
        function openEditModal(id, title, tanggal) {
            ...
            document.getElementById('editForm').action = `/absensi/${id}/update`;
            requestAnimationFrame(() => {
                content.classList.remove('scale-95', 'opacity-0');
                content.classList.add('scale-100', 'opacity-100');
            });
        ...
        function openDeleteModal(id, title) {
            ...
            form.action = `/absensi/${id}`; // Sesuaikan dengan route delete
