                ...
                <div class="mt-6 flex flex-wrap gap-2 justify-center">
                    @foreach ($pagination['links'] as $link)
                        ...
                        <a href="{{ $targetUrl }}"
                            ...
                            {{ $isActive ? 'bg-red-600 text-white border-red-600' : 'bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700' }}
